...
def main() -> None:
    ...
    test_df[TARGET_COL] = model.predict(test_df[feature_cols].to_numpy(dtype=float))

    submission_df = pd.read_csv(SAMPLE_SUBMIT_PATH, header=None, names=[ID_COL, TARGET_COL], encoding="cp932")
