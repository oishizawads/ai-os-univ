...
EXPERIMENT_ID = "expA009_snv_deriv_ridge"
SEED = 42
N_FOLDS = 5
VALIDATION = "GroupKFold_species"
MODEL_NAME = "Ridge"
PREPROCESSING = "SNV_then_SavitzkyGolay_deriv1"
METRIC = "RMSE"
ALPHA = 1.0
DATA_ENCODING = "cp932"
...
def apply_snv_deriv(x: np.ndarray) -> np.ndarray:
    return apply_deriv(apply_snv(x))
