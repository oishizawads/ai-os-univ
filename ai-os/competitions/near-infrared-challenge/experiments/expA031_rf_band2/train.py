...
SETTINGS = [
    ("snv_rf",      apply_snv,     {"n_estimators": 500, "max_features": "sqrt", "min_samples_leaf": 2, "random_state": 42, "n_jobs": -1}),
    ("snv_sg1_rf",  apply_snv_sg1, {"n_estimators": 500, "max_features": "sqrt", "min_samples_leaf": 2, "random_state": 42, "n_jobs": -1}),
    ("snv_rf_log2", apply_snv,     {"n_estimators": 500, "max_features": "log2", "min_samples_leaf": 2, "random_state": 42, "n_jobs": -1}),
]
...
def main():
    ...
    save_submission(sample_submit_df, test_df, sample_col, preds, SUBMISSIONS_DIR / f"expA031_rf_{best_name}_submission.csv")
    print(f"saved_submission=expA031_rf_{best_name}_submission.csv")
